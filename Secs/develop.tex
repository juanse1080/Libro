...
De acuerdo con los requerimientos obtenidos en el planteamiento de la web, se proyecto una arquitectura para la solucion de software llamada DeepTools
%INFORMACION DETALLADA DE LO USADO consta de esta mierda, basada en esta otra mierda, en tecnologia de mierda v 10.0 cuyo principal objetivo es la visualizacion de algoritmos para la difusion cientifica

El desarrollo de la aplicacion web cuenta con dos tipos diferentes de usuario, el usuario comun que cumple el rol mayormente de visitante, y un usuario tipo desarrollador, cumpliendo el papel de aquel usuario que crea contenido, lo actualiza y verifica su correcto funcionamiento y visualizacion en la plataforma, el usuario tipo desarrollador no tiene la necesidad de ser un experto en desarrollo web, pues una de las metas de este proyecto es facilitar el trabajo de cualquier tipo usuario en este proceso especifico para la difusion cientifica.


\subsection{Roles}
Con base en los requerimientos de la solución planteada se identificaron ciertos perfiles, y con base en estos se definieron los siguientes roles de usuario dentro del sistema:
\begin{enumerate}
    \item Usuario: El usuario es el consumidor del público general que participa como visitante casual en la pagina web, puede visualizar los proyectos y utilizar los algoritmos con las respectivas entradas y salidas.
    \item Desarrollador: El desarrollador es el tipo de usuario que enriquecen la herramienta DeepTools con contenido relevante y actualizado en torno al area de la vision por computador, sus ultimos desarrollos, algoritmos y acercamientos relacionados con esta tematica.
...
\subsubsection{Capa del servidor}
Esta estara a cargo de varias funciones del ciclo de vida del aplicativo:

\begin{itemize}
    \item Responder al cliente: Se encarga de recibir las peticiones de la capa de presentacion, procesa la información y envía las respuestas por el canal correcto.
    
    \item Peticiones a los contenedores: Esta capa tendra la responsabilidad de crear peticiones a los contenedores y enviar las respectivas respuestas a la capa de presentación.
    
    \item Peticiones de información: Se comunicara con la capa de datos para obtener información de interes para la plataforma.
\end{itemize}
...
En esta fase se definió el alcance del proyecto mediante reunionnes con el director, codirector y integrates del grupo de investigación Bivl2ab para analizar las distintas problematicas en el despliegue de algoritmos de visión por computador, se generaron de modelos y documentos que facilitaron proponer una visión general de la arquitectura de software y la producción del plan de acción de las siguientes fases de desarrollo.

\subsection{Requerimientos funcionales}
En esta etapa se realizó el levantamiento de requerimientos funcionales para continuar con cumplimiento del objetivo general planteado, llevando a cabo reuniones con con el director, codirector y integrates del grupo de investigación Bivl2ab ya que cuentan con la experiencia en la creación de algoritmos de visión por computador.

\begin{longtable}{lp{11cm}lllll}
\caption{Requerimientos funcionales}
\label{tab:requerimientosFuncionales}
% \hline
% \multicolumn{7}{c}{\textbf{Requerimientos funcionales}} \\ \hline \hline
% \endfirsthead
% \endhead
\\ \hline
\multirow{2}{*}{\textbf{Id}} & \multirow{2}{*}{\textbf{Nombre}} & \multicolumn{5}{c}{\textbf{Rol}} \\ \cline{3-7} 
 &  & \textbf{A} & \textbf{T} & \textbf{S} & \textbf{N} & \textbf{V} \\ \hline \hline
\endfirsthead
\endhead
RF01 & Permitir realizar una solicitud de implante por correo a un usuario no registrado &- &- &- &- & \checkmark \\ \hline
RF02 & Permitir crear y modificar usuarios & \checkmark &- &- &- &-  \\ \hline
RF03 & Permitir realizar un formulario formal de solicitud PSI &- &- & \checkmark &- &-  \\ \hline
RF04 & Notificar a los usuarios cuando se registre una novedad & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF05 & Proveer un espacio de comentarios para la comunicación entre los involucrados & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF06 & Proporcionar un visualizador de modelos 3D que permita agregar puntos de referencia, crear comentarios y tomar screenshots & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF07 & Permitir crear, modificar un paquete & \checkmark & \checkmark &- &- &-  \\ \hline
RF08 & Permitir crear, modificar actividades de un paquete & \checkmark & \checkmark &- &- &-  \\ \hline
RF09 & Permitir subir los archivos a una actividad & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF10 & Permitir crear y modificar roles & \checkmark &- &- &- &-  \\ \hline
RF11 & Proporcionar un sistema de inicio y cierre de sesión & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF12 & Permitir el cambio de contraseña & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF13 & Proveer un espacio para visualizar las actividades pendientes & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF14 & Proveer un espacio para visualizar los casos & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF15 & Permitir crear y modificar pacientes & \checkmark &- &- &- &-  \\ \hline
RF16 & Permitir visualizar archivos anteriormente subidos & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF17 & Guardar los cambios de los formularios a medida que se van completando & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF18 & Permitir asignar usuarios a actividades de un caso & \checkmark &- &- &- &-  \\ \hline
RF19 & Proveer un componente de dibujo & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF20 & Proveer una herramienta para crear el flujo de actividades de forma intuitiva & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF21 & Crear formularios requeridos para algunas actividades del proceso & - & - & - & - & - \\ \hline
RF22 & Verificar los datos suministrados en los formularios que actúan como salida de una actividad & - & - & - & - & - \\ \hline
RF23 & Permitir que algunos formularios no solo actúen como archivos de salida, sino que algunos tengan efecto en el flujo & - & - & - & - & - \\ \hline
RF24 & Permitir buscar en la lista de pacientes, usuarios, actividades, casos y paquetes. & \checkmark & \checkmark &- &- &-  \\ \hline
RF25 & Permitir visualizar versiones anteriormente llenadas de los formularios & \checkmark & \checkmark & \checkmark & \checkmark &-  \\ \hline
RF26 & Actualizar las notificaciones cada 5 minutos & - & - & - & - & - \\ \hline
RF27 & Calcular los días restantes para finalizar una actividad asignada & - & - & - & - & - \\ \hline
RF28 & Permitir inactivar una caso &- & \checkmark &- &- &-  \\ \hline
\end{longtable}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=0.5\textwidth]{Figs/Diagrama de Arquitectura - Estructura Árbol de Widgets}\\
...
\subsection{Metodología Scrum para validación de progreso}
    Se acuerda con la administración de MOI  realizar 4 Sprints tal como lo establece la metodología de desarrollo Ágil, que se definieron como sigue:\\
    \begin{longtable}{|p{2.5cm}|p{10cm}|}\hline
        \textbf{No. Sprint} & \textbf{Sprint}\\\hline
        1 & Verificación de requerimientos y diseño de la Aplicación\\\hline
        2 & Catálogo de productos\\\hline
        3 & Canastilla de compras\\\hline
        4 & Generación de pedidos a partir de la canastilla de compras\\\hline
        5 & Gestión de pedidos y facturación de pedidos pendientes\\\hline
        6 & Históricos, logs y preguntas frecuentes\\\hline
        7 & Importación y exportación masiva\\\hline
        8 & Manejo de sesiones y autenticación\\\hline
        9 & Menú, corrección de errores y ajustes finales\\\hline
    \end{longtable}
