...
\subsubsection{Elementos} \label{sub:elements}
...
\begin{itemize}
    \item \textbf{Algoritmo: } La visualización de un algoritmo se refiere la acción de observar  resultados de una ejecución de un algoritmo desplegado. Esta se limita a los elementos del algoritmo, dado esto solo se podrán visualizar algoritmos compatibles con los elementos preestablecidos por el desarrollador antes de su desplegué.
    \item \textbf{Ejecución: } La visualización de una ejecución se refiere la acción de observar los resultados de una prueba de un algoritmo desplegado. Esta se limita a los elementos preestablecidos durante la fase de análisis (Subsección \ref{sub:elements}), dado esto solo se podrán visualizar algoritmos compatibles con los elementos establecidos por el desarrollador antes de su desplegué.
\end{itemize}
...
\begin{longtable}{llllc}
    ...
    \endhead
    %
    \textbf{CU01} & Iniciar sesión (Tabla \ref{table:CU01})                         & RF01                               \\ \hline
    \textbf{CU02} & Cerrar sesión (Tabla \ref{table:CU02})                          & RF02                               \\ \hline
    \textbf{CU03} & Registrar usuario DeepTools (Tabla \ref{table:CU03})            & RF00                               \\ \hline

    \textbf{CU04} & Ver perfil de usuario (Tabla \ref{table:CU04})                  & -                                  \\ \hline
    \textbf{CU05} & Editar perfil de usuario (Tabla \ref{table:CU05})               & RF03                               \\ \hline
    \textbf{CU06} & Ver perfil de usuarios desarrolladores (Tabla \ref{table:CU06}) & -                                  \\ \hline

    \textbf{CU07} & Listar notificaciones (Tabla \ref{table:CU07})                  & FR17                               \\ \hline
    \textbf{CU08} & Notificar novedades a los usuarios (Tabla \ref{table:CU11})     & RF15, RF16                         \\ \hline

    \textbf{CU09} & Suscribirse a un algoritmo (Tabla \ref{table:CU08})             & RF10                               \\ \hline
    \textbf{CU10} & Cancelar suscripción (Tabla \ref{table:CU09})                   & RF11                               \\ \hline
    \textbf{CU11} & Listar suscripciones (Tabla \ref{table:CU10})                   & -                                  \\ \hline

    \textbf{CU12} & Crear solicitud (Tabla \ref{table:CU12})                        & RF03, RF24, RF13, RF21, RF22, RF23 \\ \hline
    \textbf{CU13} & Inactivar solicitud (Tabla \ref{table:CU13})                    & RF28                               \\ \hline
    \textbf{CU14} & Crear propuesta (Tabla \ref{table:CU14})                        & RF23, RF21, RF22                   \\ \hline
    \textbf{CU15} & Rechazar propuesta (Tabla \ref{table:CU15})                     & -                                  \\ \hline
    \textbf{CU16} & Asignar usuario (Tabla \ref{table:CU16})                        & RF27, RF21, RF22, RF23             \\ \hline
    \textbf{CU17} & Entregar actividad (Tabla \ref{table:CU17})                     & -                                  \\ \hline
    \textbf{CU18} & Aprobar actividad (Tabla \ref{table:CU18})                      & -                                  \\ \hline
    \textbf{CU19} & CR una versión de archivo (Tabla \ref{table:CU19})              & RF09, RF25                         \\ \hline
    \textbf{CU20} & Editar versión abierta de archivo (Tabla \ref{table:CU20})      & RF25                               \\ \hline
    \textbf{CU21} & CR comentar (Tabla \ref{table:CU21})                            & RF05                               \\ \hline
    \textbf{CU22} & Visualizar modelo (Tabla \ref{table:CU22})                      & RF06                               \\ \hline
    \textbf{CU23} & CRD marcadores (Tabla \ref{table:CU23})                         & RF06                               \\ \hline
    \textbf{CU24} & Cerrar modelo (Tabla \ref{table:CU24})                          & -                                  \\ \hline
    \textbf{CU25} & CR comentar modelo (Tabla \ref{table:CU25})                     & RF06                               \\ \hline
    \textbf{CU26} & Screenshoot (Tabla \ref{table:CU26})                            & RF06                               \\ \hline
    \textbf{CU27} & Visualizar y crear flujos (Tabla \ref{table:CU27})              & RF20, RNF01                        \\ \hline
    \textbf{CU28} & Visualizar DICOMs (Tabla \ref{table:CU28})                      & RNF01                              \\ \hline
\end{longtable}
