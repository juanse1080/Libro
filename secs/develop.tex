...
De acuerdo con el resultado de la fase de análisis se planeo una arquitectura de software para una plataforma web que implementada con , se proyecto una arquitectura para la solución de software llamada DeepTools
