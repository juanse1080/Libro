...
La ejecución se refiere al registro de la utilización de un algoritmos especifico. Un usuario suscrito a un algoritmo puede tener muchas ejecuciones y un usuario.
