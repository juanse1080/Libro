...
\begin{longtable}{lp{11cm}ll}
    ...
    \endlastfoot
    \textbf{RF00} & Permitir el registro de nuevos usuarios                                                             & \checkmark & -          \\ \hline
    \textbf{RF01} & Permitir inciar sesión a los distintos usuarios                                                     & \checkmark & \checkmark \\ \hline
    \textbf{RF02} & Permitir el cierre de sesión                                                                        & \checkmark & \checkmark \\ \hline
    \textbf{RF03} & Permitir la modificacion de la cuenta                                                               & \checkmark & \checkmark \\ \hline
    \textbf{RF04} & Permitir el despliegue de un algoritmo que cumpla con indicaciones establecidas en la documentación & \checkmark & -          \\ \hline
    \textbf{RF05} & Permitir la visualización de los detalles de los algoritmos desplegados                             & \checkmark & \checkmark \\ \hline
    \textbf{RF06} & Permitir eliminar algoritmos desplegados                                                            & \checkmark & -          \\ \hline
    \textbf{RF07} & Permitir la visualizar de los diferentes algoritmos activos                                         & \checkmark & \checkmark \\ \hline
    \textbf{RF08} & Permitir la ejecución de los algoritmos desplegados a usuarios suscritos a un algoritmo             & \checkmark & \checkmark \\ \hline
    \textbf{RF09} & Proveer durante el despliegue de un algoritmo el seguimiento en tiempo real del proceso             & \checkmark & -          \\ \hline
    \textbf{RF10} & Notificar errores durante la ejecución de algoritmos                                                & \checkmark & \checkmark \\ \hline
    \textbf{RF11} & Permitir la suscribirse a un algoritmo activo                                                       & \checkmark & \checkmark \\ \hline
    \textbf{RF12} & Permitir consultar y eliminar ejecuciones de su autoría                                             & \checkmark & \checkmark \\ \hline
    \textbf{RF13} & Permitir la descarga de elementos multimedia de ejecuciones de su autoría                           & \checkmark & \checkmark \\ \hline
    \textbf{RF14} & Permitir ejecutar pruebas sencillas de un algoritmo para probar su funcionamiento                   & \checkmark & \checkmark \\ \hline
    \textbf{RF15} & Proveer durante la ejecución de un algoritmo el seguimiento en tiempo real del proceso              & \checkmark & \checkmark \\ \hline
    \textbf{RF16} & Notificar al usuario cuando haya finalizado las ejecuciones de un algoritmo activo                  & \checkmark & \checkmark \\ \hline
    \textbf{RF17} & Permitir agregar y eliminar usuarios suscritos a un algoritmo de su autoría                         & \checkmark & -          \\ \hline
\end{longtable}
...
\begin{longtable}{llllc}
    ...
    \label{tab:use_cases}
    \\ \hline
    \textbf{Id}   & \textbf{Nombre}                                         & \textbf{RF/RNF} \\ \hline
    \endfirsthead
    %
    \endhead
    %
    \textbf{CU00} & Iniciar sesión (Tabla \ref{table:CU00})                 & RF01            \\ \hline
    \textbf{CU01} & Cerrar sesión (Tabla \ref{table:CU01})                  & RF02            \\ \hline
    \textbf{CU02} & Registrar usuario (Tabla \ref{table:CU02})              & RF00            \\ \hline
    \textbf{CU03} & Ver perfil (Tabla \ref{table:CU03})                     & -               \\ \hline
    \textbf{CU04} & Editar perfil (Tabla \ref{table:CU04})                  & RF03            \\ \hline
    \textbf{CU05} & Ver perfil de desarrolladores (Tabla \ref{table:CU05})  & -               \\ \hline
    \textbf{CU06} & Listar notificaciones (Tabla \ref{table:CU06})          & -               \\ \hline
    \textbf{CU07} & Notificar novedades (Tabla \ref{table:CU07})            & RF10, RF17      \\ \hline
    \textbf{CU08} & Suscribirse (Tabla \ref{table:CU08})                    & RF11            \\ \hline
    \textbf{CU09} & Cancelar suscripción (Tabla \ref{table:CU09})           & RF12            \\ \hline
    \textbf{CU10} & Listar suscripciones (Tabla \ref{table:CU10})           & -               \\ \hline
    \textbf{CU11} & Desplegar algoritmo (Tabla \ref{table:CU11})            & RF04            \\ \hline
    \textbf{CU12} & Iniciar algoritmos (Tabla \ref{table:CU12})             & -               \\ \hline
    \textbf{CU13} & Detener algoritmos (Tabla \ref{table:CU13})             & -               \\ \hline
    \textbf{CU14} & Eliminar algoritmos (Tabla \ref{table:CU14})            & RF06            \\ \hline
    \textbf{CU15} & Administrar usuarios (Tabla \ref{table:CU15})           & RF18            \\ \hline
    \textbf{CU16} & Ejecutar algoritmo (Tabla \ref{table:CU16})             & RF08, RF15      \\ \hline
    \textbf{CU17} & Listar ejecuciones (Tabla \ref{table:CU17})             & -               \\ \hline
    \textbf{CU18} & Ver ejecución (Tabla \ref{table:CU18})                  & RF09            \\ \hline
    \textbf{CU19} & Eliminar ejecución (Tabla \ref{table:CU19})             & RF13            \\ \hline
    \textbf{CU20} & Clonar ejecución (Tabla \ref{table:CU20})               & RF05            \\ \hline
    \textbf{CU21} & Filtrar algoritmos (Tabla \ref{table:CU21})             & RF06            \\ \hline
    \textbf{CU22} & Listar algoritmos (Tabla \ref{table:CU22})              & RF07            \\ \hline
    \textbf{CU23} & Descargar elementos multimedia (Tabla \ref{table:CU23}) & RF14            \\ \hline
\end{longtable}
