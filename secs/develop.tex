...
\begin{longtable}{llllc}
    ...
    \textbf{CU12} & Iniciar algoritmo (Tabla \ref{table:CU12})             & -               \\ \hline
    \textbf{CU13} & Detener algoritmo (Tabla \ref{table:CU13})             & -               \\ \hline
    \textbf{CU14} & Eliminar algoritmo (Tabla \ref{table:CU14})            & RF06            \\ \hline
